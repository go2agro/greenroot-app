        ...
        <div className="flex-1 overflow-auto">
          <div className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl border border-gr-border mb-6 overflow-hidden">
              ...
              >
                <h2 className="text-lg font-bold text-gray-900">
                  Section B: <span className="text-gr-secondary">Contact Information</span>
                </h2>
            ...
            <div className="bg-white rounded-2xl border border-gr-border mb-6 overflow-hidden">
              ...
              >
                <h2 className="text-lg font-bold text-gray-900">
                  Section C: <span className="text-gr-secondary">Address Details</span>
                </h2>
            ...
            <div className="bg-white rounded-2xl border border-gr-border mb-6 overflow-hidden">
              ...
              >
                <h2 className="text-lg font-bold text-gray-900">
                  Section D: <span className="text-gr-secondary">Identity & Documents</span>
                </h2>
