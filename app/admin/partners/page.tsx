            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className={KPI_CARD_CLASS}>
                {isLoading ? (
                  ...
                  <>
                    <Handshake className="w-8 h-8 text-gr-primary mb-3" />
                ...
                <div className="space-y-3 md:space-y-0 md:border md:border-t-0 md:border-gr-border md:rounded-b-2xl md:overflow-hidden">
                  {paginatedPartners.map((partner) => {
                    ...
                    return (
                      <div
                        key={partner.id}
                        className={`bg-white border border-gr-border md:border-0 md:border-b md:last:border-b-0 rounded-2xl md:rounded-none p-4 ${TABLE_GRID_CLASS}`}
                      >
